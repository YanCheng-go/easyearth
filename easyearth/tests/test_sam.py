...
class TestSam:
    ...
    def test_points(self):
        ...
        image_embeddings = self.sam.get_image_embeddings(self.raw_image)
        masks, scores = self.sam.get_masks(self.raw_image, image_embeddings=image_embeddings, input_points=self.input_points)
    ...
    def test_boxes(self):
        ...
        image_embeddings = self.sam.get_image_embeddings(self.raw_image)
        masks, scores = self.sam.get_masks(self.raw_image, image_embeddings=image_embeddings, input_boxes=self.input_boxes)
        assert len(masks[0]) == 2
        assert len(scores) == 2
    ...
    def test_multiple(self):
        ...
        image_embeddings = self.sam.get_image_embeddings(self.raw_image)
        masks, scores = self.sam.get_masks(self.raw_image, image_embeddings=image_embeddings, input_points=self.input_points, input_boxes=self.input_boxes)
    ...
    def test_labels(self):
        ...
        image_embeddings = self.sam.get_image_embeddings(self.raw_image)
        masks, scores = self.sam.get_masks(self.raw_image, image_embeddings=image_embeddings, input_labels=self.input_labels)
        assert len(masks[0]) == 2
        assert len(scores) == 2
