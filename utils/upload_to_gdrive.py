...
def main(FILE_ID=None, shareable: bool = True, VERSION='') -> (str, bool):
    ...
    file_metadata = {'name': f'easyearth_env{VERSION}.zip'}
    media = MediaFileUpload(f'easyearth_env{VERSION}.zip', mimetype='application/zip')
...
if __name__ == '__main__':
    main(FILE_ID='1FXmE_R1ZRoH3IHzv139stxNywB3HfgXo', shareable=True, VERSION='_test')  # Replace with your Google Drive file ID if updating an existing file
